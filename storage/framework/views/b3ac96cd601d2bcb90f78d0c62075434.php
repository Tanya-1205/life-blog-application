                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            ...
                                            <a href="<?php echo e(route('blog.edit', $blog->id)); ?>"
                                                ...
                                                data-kt-ecommerce-product-filter="product_name"><?php echo e($blog->title); ?> </a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class=" pe-0" data-order="21">
                                    <span class="fw-bold ms-3"><?php echo e(ucwords($blog->author)); ?> </span>
                                </td>
                                <td class=" pe-0">
                                    <a href="<?php echo e(route('blog.edit', $blog->id)); ?>" class="symbol symbol-50px">
                                        <span class="symbol-label"> <img src="<?php echo e(asset($blog->thumbnail)); ?>" alt="image"
                                ...
                                <td class="pe-0" data-order="Published">
                                    <?php if($blog->status == 'Show'): ?>
                                        <!--begin::Badges-->
                                        <div class="badge badge-light-success"><?php echo e(ucwords($blog->status)); ?> </div>
                                        <!--end::Badges-->
                                    <?php else: ?>
                                        <!--begin::Badges-->
                                        <div class="badge badge-light-primary"><?php echo e(ucwords($blog->status)); ?> </div>
                                    <?php endif; ?>
                                    <!--end::Badges-->
                                </td>

                                <td class=" pe-0" data-order="Published">
                                    <a href="<?php echo e(route('blog.edit', $blog->id)); ?>" class="menu-link px-3"
    ...
    <script>
        function deleteBlog(value) {
            ...
            if (x)
                $.ajax({
                    type: 'get',
                    url: "<?php echo e(url('admin/blog/delete')); ?>/" + value,
                    success() {
                        location.reload();
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/smsnot/tanyalifestyles.nrrectrust.org/admin/resources/views/admin/blog/all.blade.php ENDPATH**/ ?>