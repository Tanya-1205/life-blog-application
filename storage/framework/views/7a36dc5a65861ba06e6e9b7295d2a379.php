        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                    <?php echo e($site->site_name); ?></h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="<?php echo e(url('/admin/dashboard')); ?>" class="text-muted text-hover-primary">Home</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-ecommerce-product-filter="search" name="search"
                                    value="<?php echo e(request('search')); ?>" class="form-control form-control-solid w-250px ps-12"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        ...
                                        <form id="kt_modal_add_user_form" class="form"
                                            action="<?php echo e(route('category.store')); ?>" method="POST"
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="<?php echo e(asset($category->image)); ?>" style="width: 80px;height:50px"
                                                alt="">
                                        </div>
                                    </td>
                                    <td class=" pe-0" data-order="Published">
                                        <?php if($category->status == 'Show'): ?>
                                            <div class="badge badge-light-success"><?php echo e(ucwords($category->status)); ?>

                                            </div>
                                        <?php else: ?>
                                            <div class="badge badge-light-primary"><?php echo e(ucwords($category->status)); ?>
                                    ...
                                    <td>
                                        <div class="menu-item px-3">
                                            <button id="<?php echo e($category->id); ?>"
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <form id="kt_modal_add_user_edit_form" class="form" action="<?php echo e(route('category.update', 0)); ?>"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.kt_modal_add_user_edit').click(function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "<?php echo e(url('admin/category')); ?>/" + value,
                    success(data) {
                        console.log(data);
                        $('#edit_id').val(data.id);
    ...
    <script>
        function deleteCategory(value) {
            ...
            if (x)
                $.ajax({
                    type: 'get',
                    url: "<?php echo e(url('admin/category/delete')); ?>/" + value,
                    success() {
                        location.reload();
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/smsnot/tanyalifestyles.nrrectrust.org/admin/resources/views/admin/category/all.blade.php ENDPATH**/ ?>