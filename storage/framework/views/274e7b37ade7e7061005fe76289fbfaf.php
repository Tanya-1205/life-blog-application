...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('admin')); ?>/assets/media/logos/favicon.ico" />
                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100">
                            ...
                            <div class="text-center mb-11">
                                ...
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6"><?php echo e($site->site_name); ?></div>
                                <!--end::Subtitle=-->
                            </div>
                            <!--begin::Heading-->
    ...
    <script>
        ...
        function checkAdminEmail(val) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "<?php echo e(route('validateAdminEmail')); ?>",
                data: {
                    email: email
                },
    ...
    <script>
        function formSubmit() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "<?php echo e(route('loginAction')); ?>",
                data: {
                    email: email,
                    password: password
                },
...
<?php /**PATH /home/smsnot/tanyalifestyles.nrrectrust.org/admin/resources/views/admin/login.blade.php ENDPATH**/ ?>